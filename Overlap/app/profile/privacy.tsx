...
export default function Privacy() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setShowProfilePublic(!!s.showProfilePublic);
        setShowActivityToFriends(!!s.showActivityToFriends);
        setAllowFriendRequests(!!s.allowFriendRequests);
        setShareEmailWithFriends(!!s.shareEmailWithFriends);
        setBlockedUsers(Array.isArray(s.blockedUsers) ? s.blockedUsers : []);
      } catch (e) {
        console.error('load privacy settings failed:', e);
      } finally {
        setLoading(false);
      }
    })();
  ...
  const onSave = async () => {
    try {
      ...
      console.error('save privacy settings failed:', e);
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            <View style={styles.rowTextWrap}>
              ...
              <Text style={styles.rowSub}>Share liked activities and collections with friends.</Text>
            </View>
            <Switch
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            <View style={styles.rowTextWrap}>
              ...
              <Text style={styles.rowSub}>Let others find and send you friend requests.</Text>
            </View>
            <Switch
          ...
          <View style={styles.row}>
            <View style={styles.rowTextWrap}>
              ...
              <Text style={styles.rowSub}>Let your friends see the email on your profile.</Text>
            </View>
            <Switch
        ...
        <View style={styles.card}>
          ...
          {blockedUsers.length === 0 ? (
            <Text style={styles.emptyText}>{loading ? 'Loading…' : 'No one blocked.'}</Text>
          ) : (
        ...
        <TouchableOpacity style={styles.primaryBtn} onPress={onSave} activeOpacity={0.88} disabled={loading}>
...
const styles = StyleSheet.create({
  ...
  headerRow: {
    ...
    paddingTop: 8, paddingBottom: 12, justifyContent: 'space-between',
  },
  iconBtn: {
  ...
  card: { backgroundColor: CARD, borderRadius: 12, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: BORDER },
  cardTitle: { color: '#fff', fontWeight: '800', fontSize: 16, marginBottom: 12 },
  row: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, gap: 12, borderTopWidth: 1, borderTopColor: BORDER },
  rowTextWrap: { flex: 1 },
  ...
  input: {
    flex: 1, backgroundColor: INPUT_BG, color: '#fff', paddingHorizontal: 12, paddingVertical: 10,
    borderRadius: 8, borderWidth: 1, borderColor: '#2a2a2a',
  },
  blockBtn: { backgroundColor: '#F44336', paddingHorizontal: 14, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  ...
  blockChip: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#2a2f36', borderRadius: 16, paddingHorizontal: 10, paddingVertical: 6 },
  blockChipText: { color: '#fff', fontSize: 13, marginRight: 6 },
  unblockIcon: { width: 18, height: 18, borderRadius: 9, backgroundColor: 'rgba(255,255,255,0.18)', alignItems: 'center', justifyContent: 'center' },
  primaryBtn: {
    backgroundColor: ACCENT, borderRadius: 10, paddingVertical: 14, alignItems: 'center', marginTop: 6,
